...
# # ETL of all cards and sets in database
...
release_dates = pd.DataFrame(
    [
        {"set_id": k, "release_date": pd.to_datetime(v["releaseDate"])}
...
cards_df["text_preworked_word_count"] = cards_df["text_preworked"].apply(count_words)
